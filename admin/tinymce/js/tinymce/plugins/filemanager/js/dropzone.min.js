(function () {
    ...
    e.modules = {}, e.aliases = {}, e.resolve = function (i) {
        ...
        (function () {
            var e, n, r, s, o, l, a = {}.hasOwnProperty, p = function (e, t) {
                function i() {
                    this.constructor = e
                }
            ...
            n = "undefined" != typeof Emitter && null !== Emitter ? Emitter : t("emitter"), o = function () {
                ...
                return p(t, e), t.prototype.events = ["drop", "dragstart", "dragend", "dragenter", "dragover", "dragleave", "selectedfiles", "addedfile", "removedfile", "thumbnail", "error", "processingfile", "uploadprogress", "sending", "success", "complete", "reset"], t.prototype.defaultOptions = {
                    ...
                    }, s = ["div", "form"], n = 0, r = s.length; r > n; n++) if (i = s[n], e = t(this.element.getElementsByTagName(i))) return e
                    ...
                    }, p.setRequestHeader("Accept", "application/json"), p.setRequestHeader("Cache-Control", "no-cache"), p.setRequestHeader("X-Requested-With", "XMLHttpRequest"), p.setRequestHeader("X-File-Name", 1/*e.name*/), t = new FormData, this.options.params) {
                        h = this.options.params;
                        for (o in h) a = h[o], t.append(o, a)
                    }
                    if ("FORM" === this.element.tagName) for (m = this.element.querySelectorAll("input, textarea, select, button"), c = 0, u = m.length; u > c; c++) n = m[c], r = n.getAttribute("name"), s = n.getAttribute("type"), (!s || "checkbox" !== s.toLowerCase() || n.checked) && t.append(r, n.value);
                ...
                var t, i, n, r, s;
                if (t = !0, window.File && window.FileReader && window.FileList && window.Blob && window.FormData && document.querySelector) if ("classList" in document.createElement("a")) for (s = e.blacklistedBrowsers, n = 0, r = s.length; r > n; n++) i = s[n], i.test(navigator.userAgent) && (t = !1); else t = !1; else t = !1;
                return t
            }, l = function (e, t) {
                var i, n, r, s;
