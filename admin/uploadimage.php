...
include_once('../libs/php_image_magician.php');
...
function cropImage() {
	if(strpos($_POST['realH'],'watermark') !== false){
		$_POST['realH'] = str_replace ('watermark','',$_POST['realH']);
		$watermark = true;
	}
	$x1 = $_POST['x1'] + 1 - 1;
	$x2 = $_POST['x2'] + 1 - 1;
	...
	if($watermark){
		$wm_path = DOC_ROOT."/files/$resize/".$fileName;
		exec("composite -gravity south /var/www/web/sites/maestria.bagetural.ru/images/real/wm/wm.png $wm_path $wm_path");
	}
	die();
}
